...
HD_PWD='E:/M10702114/ntust_HSCodesign_et5342701/fpga/barrage_game/barrage_game.runs/system_controlanddisplayIP_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_controlanddisplayIP_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_controlanddisplayIP_0_1.tcl
