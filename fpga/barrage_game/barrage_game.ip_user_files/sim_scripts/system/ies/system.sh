...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../barrage_game.srcs/sources_1/bd/system/ipshared/7dd0/hdl" \
       +incdir+"$ref_dir/../../../../barrage_game.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../barrage_game.srcs/sources_1/bd/system/ipshared/7dd0/hdl" \
       +incdir+"../../../../barrage_game.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
